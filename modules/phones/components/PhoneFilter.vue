  ...
  <div class="flex">
    <div v-for="(filter, key) of filterConfig" :key="key" class="mr-2 filter">
      <div class="group relative">
        ...
        <div
          class="absolute left-0 top-full z-10 hidden rounded-md bg-white py-2 px-4 text-base shadow-lg shadow-gray-800 transition ease-in-out group-hover:inline-block sm:text-sm"
        >
          <MultiSelect
            :value="newValue[key]"
